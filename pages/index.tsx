...
const Home =  (props: Props) => {
  ...
  console.log("ssr posts", props.posts)
  const {posts} = props;
      ...
      <div className="flex justify-between items-center bg-yellow-400 border-y border-black py-10 lg:py-0">
        <div className="px-10 space-y-5">
          <h1 className="text-6xl max-w-xl font-serif">
            ...
            is a place to wrtie, read, and connect
          </h1>
          <h2>
          ...
          {posts.map((post, index) => (
            <Link key={post._id} href={`/post/${post.slug.current}`}>
              <div className="group border rounded-lg cursor-pointer overflow-hidden">
                <img 
                className="h-60 w-full object-cover group-hover:scale-100 transition-transform duration-200 ease-in-out"
